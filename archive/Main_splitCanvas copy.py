...
def drawNodePlayground(app):
    drawRect(app.canvasWidth + app.splitterWidth, 0, app.nodeZoneWidth, app.height, fill='white')
    drawRect(app.canvasWidth + app.splitterWidth, 0, app.nodeZoneWidth, app.toolbarHeight, fill='darkgrey')
    drawLabel('Toolbar', app.canvasWidth + app.splitterWidth + app.nodeZoneWidth / 2, app.toolbarHeight / 2, size=14, fill='white', font = 'monospace')
    drawLabel('Node Manipulation Zone', app.canvasWidth + app.splitterWidth + app.nodeZoneWidth / 2, app.height / 2, size=20, font = 'monospace')
